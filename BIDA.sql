...
SELECT @MNV=MANV FROM NHANVIEN WHERE MANV=@MANV
if(@MNV=null)
BEGIN
IF EXISTS(SELECT MANV FROM PHUCVU WHERE MANV=@MNV) OR EXISTS(SELECT MADANGNHAP FROM TAIKHOAN WHERE MADANGNHAP=@MNV)
BEGIN
DELETE from PHUCVU WHERE MANV=@MNV
DELETE FROM TAIKHOAN WHERE MADANGNHAP=@MANV
END
END
else
BEGIN
